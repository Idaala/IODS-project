# Learning the basics, IODS course project

# About the project

### The student2014 dataset contains 7 variables with 166 observations. The data has been collected from course:" Johdatus yhteiskuntatilastotieteeseen 2014" and the observations were collected 3.12.2014 - 10.1.2015. Students' approaches to learning are examined in this questionnaire. The dataset has been modified to combine questions and to remove point values of 0.
...
### The data contains 60 variables and 183 observations in those 60 variables. Next we create an analysis dataset with the variables gender, age, attitude, deep, stra, surf and points. We can first check the variables
```{r}
...
### next we create the variables deep, stra and surf
```{r}
...
```
### The scatterplotmatrix shows that attitude (0.436), stra (0.146), and surf (-0,144) have the strongest correlations with points. As a result, these variables will function as explanatory variables. 
